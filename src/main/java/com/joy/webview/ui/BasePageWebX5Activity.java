...
public class BasePageWebX5Activity extends BaseUiActivity implements BaseViewPageWeb<BasePageWebX5Fragment> {

    @Inject
    UIPageDelegate<BasePageWebX5Fragment> mUIDelegate;
    ...
    public UIPageDelegate<BasePageWebX5Fragment> getUIDelegate() {
        return mUIDelegate;
    }

    @Override
    public BasePageWebX5Fragment getFragment(@NonNull String url) {
        return BasePageWebX5Fragment.instantiate(this, url);
    }
    ...
    public static void startActivity(Activity act, ArrayList<? extends BasePageEntity> pageEntities, int position) {
        Intent intent = new Intent(act, BasePageWebX5Activity.class);
