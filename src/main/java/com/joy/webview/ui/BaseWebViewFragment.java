...
public class BaseWebViewFragment extends BaseHttpUiFragment implements BaseViewWeb<FragmentEvent>, KConstant {
    ...
    private BaseWebViewComponent component() {
        return DaggerBaseWebViewComponent.builder()
                ...
                .baseWebViewModule(new BaseWebViewModule(this, getActivity().getIntent().getBooleanExtra(KEY_CACHE_ENABLE, false)))
                .build();
    }
    ...
    public static BaseWebViewFragment instantiate(@NonNull Context context, @NonNull String url) {
        return instantiate(context, url, false);
    }

    public static BaseWebViewFragment instantiate(@NonNull Context context, @NonNull String url, boolean cacheEnable) {
        Bundle bundle = new Bundle();
        bundle.putString(KEY_URL, url);
        bundle.putBoolean(KEY_CACHE_ENABLE, cacheEnable);
        return (BaseWebViewFragment) Fragment.instantiate(context, BaseWebViewFragment.class.getName(), bundle);
    }
}
